...
## allow forecast products to be used
    parser.add_argument(
            ...
            dest='allow_fc',
            action='store_true',
            help='If needed, allow the downloading of forecast VMF3 grid file(s)')
